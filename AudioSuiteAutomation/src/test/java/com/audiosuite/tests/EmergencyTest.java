...
public class EmergencyTest extends BaseClass {
	...
	public void testEmergencyFunctionality() throws InterruptedException {
		...
		newEmergencyPage.saveEmergency("Test" + jutil.getSysystemTime(), "Testing", "1234567", 1);
		Thread.sleep(1000);
		newEmergencyPage.expandSecurityOptions();
		Thread.sleep(1000);
		newEmergencyPage.addAccessCode("1245");
		newEmergencyPage.addCliTrigger("7894561230");
		newEmergencyPage.clickSave();
		...
		emergencyPage.triggerEmergencyButton("Test");
		softAssert.assertTrue(emergencyPage.isEmergencyTriggered("Test"));
		log.info("Emergency triggered successfully.");
		softAssert.assertTrue(emergencyPage.isStatusRunningDisplayed());
